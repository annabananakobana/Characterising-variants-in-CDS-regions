...
grep -Fwf female_genes.txt GCF_011064425.1_Rrattus_CSIRO_v1_genomic.gff | awk '{if ($3=="CDS") print $0}' | convert2bed --input=gff | sed -e 's/ /_/g' > CDS_loci_female.bed 2> CDS_loci_female.se
